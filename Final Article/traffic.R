...
traffic.data <- as.matrix(read.csv("C:/Users/gvamorim/Documents/Personal/Repositories/ANN-Artificial-Neural-Network/Final Article/Behavior of the urban traffic of the city of Sao Paulo in Brazil.csv", 
                                header = TRUE, sep = ";", dec = ",", stringsAsFactors=FALSE))

X<-as.matrix(traffic.data[1:dim(traffic.data)[1], 2:17])
Y<-as.matrix(traffic.data[1:dim(traffic.data)[1], 18])
